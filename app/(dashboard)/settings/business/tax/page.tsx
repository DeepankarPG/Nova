  ...
  return (
    <div className="space-y-8">
      <div className="space-y-1">
        <h3 className="text-base font-semibold text-foreground">Tax details</h3>
      ...
      <div className="rounded-lg border border-dashed border-border bg-muted/20 p-4 text-sm text-muted-foreground">
        PayGlocal surfaces GST on settlements and exports where required. Customer-facing pages follow RBI and branding guidelines;
        your legal team remains responsible for filings.
      </div>
