...
export function SortableDashboardWidget({
  ...
  const removeBtnClass = cn(
    "absolute top-2 right-2 z-30 inline-flex h-8 w-8 items-center justify-center rounded-lg text-muted-foreground transition-colors",
  ...
  const body = (
    ...
    >
      ...
      <DashboardWidgetRenderer widgetId={id} isLoading={isLoading} />
    </div>
  );
