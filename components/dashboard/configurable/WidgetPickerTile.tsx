...
import type { WidgetCatalogEntry } from "@/lib/dashboard-widget-catalog";
...
export function WidgetPickerTile({
  ...
  return (
    <div
      ...
      aria-label={selected ? `${entry.name}, selected. Click to remove from dashboard.` : `${entry.name}. Click to add to dashboard.`}
    >
