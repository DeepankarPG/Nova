    ...
    <AnimatePresence>
      {open && (
        <>
          ...
          <motion.aside
            key="drawer"
            className={`${pos} left-0 top-0 bottom-0 z-[51] w-[280px] bg-card flex flex-col shadow-2xl`}
            initial={{ x: "-100%" }}
            animate={{ x: 0 }}
            exit={{ x: "-100%" }}
          ...
          >
            ...
            <div className="px-2 py-3 border-t border-border shrink-0">
              <button
                ...
                className="flex items-center gap-3 w-full px-3 py-2.5 rounded-xl text-destructive hover:bg-destructive/[0.06] transition-colors"
              >
