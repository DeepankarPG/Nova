...
export function SettingsShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-[inherit] flex-col gap-4 md:flex-row md:items-stretch md:gap-3">
      <motion.aside
        className="w-full shrink-0 border-border md:w-[13.25rem] md:border-r md:pr-3 dark:border-zinc-800"
      ...
      >
        <div className="min-h-[inherit] flex-1 py-1 pl-0 pr-0 md:pl-5 md:pr-2 lg:pl-8 lg:pr-4">{children}</div>
      </motion.div>
    </div>
  );
}
